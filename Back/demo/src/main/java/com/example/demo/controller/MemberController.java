...
public class MemberController {
	...
	public ResponseEntity<PageResultVO<PointDTO>> userPoint(@PathVariable long mnum, PageRequestDTO pageRequestDTO,
		...
		if (result == null)
			return new ResponseEntity<>(new PageResultVO<PointDTO>(), HttpStatus.ACCEPTED);
	...
	public ResponseEntity<PageResultVO<PointDTO>> activityHistory(@PathVariable long mnum,
	...
	public ResponseEntity<PageResultVO<DishLikeDTO>> likeList(@PathVariable long mnum, PageRequestDTO pageRequestDTO,
			HttpServletRequest request) {
		...
		if (result == null)
			return new ResponseEntity<>(new PageResultVO<DishLikeDTO>(), HttpStatus.ACCEPTED);
	...
	public ResponseEntity<PageResultVO<DishCommDTO>> commList(@PathVariable long mnum, PageRequestDTO pageRequestDTO,
			HttpServletRequest request) {
		...
		if (result == null)
			return new ResponseEntity<>(new PageResultVO<DishCommDTO>(), HttpStatus.ACCEPTED);
	...
	public ResponseEntity<PageResultVO<AteDTO>> getAteUserList2(@PathVariable long mnum, HttpServletRequest request,
		...
		if (result == null)
			return new ResponseEntity<>(new PageResultVO<AteDTO>(), HttpStatus.ACCEPTED);
